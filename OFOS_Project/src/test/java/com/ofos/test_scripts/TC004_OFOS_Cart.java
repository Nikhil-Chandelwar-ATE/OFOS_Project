...
import com.ofos.pom_classes.Restaurants_Page;
import com.ofos.pom_classes.Welcome_Page;
import com.relevantcodes.extentreports.LogStatus;

import generic.Base_Test;

public class TC004_OFOS_Cart extends Base_Test{
	...
	public void addToCart() throws InterruptedException {
		...
		clickAction(wp.getRestaurantsLink());
		Restaurants_Page rsp = new Restaurants_Page(driver);
		
		Assert.assertEquals(rsp.getRestaurantLink().isDisplayed(), true);
		clickAction(rsp.getViewMenuLink());
		Thread.sleep(2000);
