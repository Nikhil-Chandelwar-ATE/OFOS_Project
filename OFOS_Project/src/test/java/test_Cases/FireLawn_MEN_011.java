...
public class FireLawn_MEN_011 extends Base_Test{

	@Test
	public void discountPriceOfProduct() throws Throwable {
		...
		if (tp.getProducts().size()>0) {
			...
			Assert.assertEquals(tp.getProductPrice().isDisplayed(), true);
			test.log(LogStatus.PASS, test.addScreenCapture(getWebelementScreenshot(tp.getProductPrice())));
		}
		else {
