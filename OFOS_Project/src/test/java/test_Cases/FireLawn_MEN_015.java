...
public class FireLawn_MEN_015 extends Base_Test{

	@Test
	public void addToCartConvertedToAdded() throws Throwable {
		...
		if(tp.getAllProducts().isDisplayed()) {
			...
			action.moveToElement(tp.getAddToCartButton()).click().perform();
